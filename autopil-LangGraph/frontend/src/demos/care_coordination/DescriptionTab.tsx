...
export default function DescriptionTab() {
  const coordinator = AGENT_POLICIES[0];
  ...
  return (
    <div className="description-tab">
      <section className="desc-section">
        ...
        <p>
          Five AI agents work a care-coordination case the way a real care team
          would — a coordinator, a triage nurse, a clinical chart reviewer, a
          medication reviewer, and a chronic-care outreach specialist — each given
          access to more patient data than it's actually allowed to use.
        </p>
        <p>
          AutoPIL is the policy layer that decides, in real time, what each agent can
          see. When an agent reaches for PHI outside its lane, AutoPIL blocks it and
          logs why — the same way it would in production, not because the demo told it
          not to look there. And no clinical or outreach action happens on an AI's
          say-so: a human care-team reviewer signs off or overrides every recommendation
          before it's final.
        </p>
        <details className="desc-technical">
          ...
          <p>
            ...
            EHR or pharmacy system is involved anywhere — every guarded getter reads from
      ...
      <section className="desc-section">
        ...
        <div className="flow-diagram">
          <div className="flow-box flow-orchestrator">
            <div className="flow-box-title">{coordinator.displayName}</div>
            <div className="flow-box-sub">{coordinator.description}</div>
          </div>
          ...
          <div className="flow-box flow-sar">
            <div className="flow-box-title">Care Summary</div>
            <div className="flow-box-sub">
              {coordinator.displayName} compiles the final care-coordination narrative
              from compiled findings only — same role it plays at intake, reused rather
              than a separate 6th role.
            </div>
          </div>
          <div className="flow-arrow-down" />
          <div className="flow-box flow-review">
            <div className="flow-box-title">Human Care-Team Review</div>
          ...
          <div className="flow-box flow-decision">
            ...
            <div className="flow-box-sub">Rule-based, not LLM-improvised — an LLM can draft the narrative, it shouldn't decide the clinical action.</div>
          </div>
        </div>
      </section>
      ...
      <section className="desc-section">
        ...
        <p>
          ...
          <code>policies/healthcare/clinical_operations.yaml</code>, not invented for
          display. Every allowed/denied source below is checked by AutoPIL at retrieval
          time, regardless of what the agent's own toolbelt makes available.
        </p>
