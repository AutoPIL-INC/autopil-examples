...
const THEME_KEY = "autopil_client_analysis_demo_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="client-analysis-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">Client Analysis</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph × AWS Bedrock — client analysis demo (Databricks Unity Catalog)</span>
