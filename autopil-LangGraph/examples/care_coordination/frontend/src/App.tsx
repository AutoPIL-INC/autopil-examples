...
const THEME_KEY = "autopil_care_coordination_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="care-coordination-demo" /></div>
          <div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven care coordination demo</span>
