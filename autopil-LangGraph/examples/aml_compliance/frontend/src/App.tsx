...
const THEME_KEY = "autopil_aml_demo_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="aml-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">AML &amp; Compliance</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven AML &amp; compliance investigation demo</span>
