...
const THEME_KEY = "autopil_splunk_secops_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="splunk-secops-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">SOC / Splunk SecOps</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven SOC / Splunk SecOps demo</span>
