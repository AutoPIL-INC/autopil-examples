...
const THEME_KEY = "autopil_hospital_revenue_cycle_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="hospital-revenue-cycle-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">Hospital Revenue Cycle</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven hospital revenue cycle demo</span>
