...
const THEME_KEY = "autopil_quality_control_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="quality-control-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">Quality Control</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven quality control demo</span>
