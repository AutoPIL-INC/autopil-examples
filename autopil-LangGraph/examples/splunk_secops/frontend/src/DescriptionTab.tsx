...
export default function DescriptionTab() {
  ...
  const synthesizer = AGENT_POLICIES[4];
  ...
  return (
    <div className="description-tab">
      <section className="desc-section">
        ...
        <p>
          Five AI agents work a SOC case the way a real security operations team would —
          an orchestrator, a security auditor, an incident triage analyst, a compliance
          reporter, and a threat-report writer — each given access to more Splunk data
          (forwarded from IBM mainframe SMF logs) than it's actually allowed to use.
        </p>
        <p>
          ...
          there. And no case closes on an AI's say-so: a human SOC reviewer signs off or
          overrides every recommendation before it's final.
        </p>
        <details className="desc-technical">
          ...
          <p>
            ...
            Splunk instance is involved anywhere — every guarded getter reads from
      ...
      <section className="desc-section">
        ...
        <div className="flow-diagram">
          ...
          <div className="flow-box flow-sar">
            <div className="flow-box-title">{synthesizer.displayName}</div>
            <div className="flow-box-sub">{synthesizer.description}</div>
          </div>
          <div className="flow-arrow-down" />
          <div className="flow-box flow-review">
            <div className="flow-box-title">Human SOC Review</div>
      ...
      <section className="desc-section">
        ...
        <p>
          ...
          <code>policies/SecOps/soc_mainframe_logs.yaml</code>, not invented for display.
