...
const THEME_KEY = "autopil_trading_desk_ops_theme";
  ...
  return (
    <div className="app-shell">
      <header className="header">
        <div className="logo">
          <div className="logo-mark"><LogoMark id="trading-desk-ops-demo" /></div>
          <div>
            <div className="logo-name">Auto<span className="accent">PIL</span></div>
            <div className="logo-sub">Trading Desk Ops</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>AutoPIL × LangGraph — reasoning-driven trading desk ops demo</span>
